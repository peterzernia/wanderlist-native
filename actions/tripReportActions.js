...
user.
*/
export const postTripReport = (token, author, title, content, countries) => (dispatch) => axios
  .post(
...
export const deleteTripReport = (token, tripReport) => (dispatch) => axios
